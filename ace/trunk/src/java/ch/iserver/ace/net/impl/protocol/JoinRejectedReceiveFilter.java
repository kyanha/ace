 ...
 *
 */
public class JoinRejectedReceiveFilter extends AbstractRequestFilter {

	private static Logger LOG = Logger.getLogger(JoinRejectedReceiveFilter.class);
	
	public JoinRejectedReceiveFilter(RequestFilter successor) {
		super(successor);
	}
