...
public class CollaborativeDocument extends StyleChangedDocument {
	...
	public void applyInsertString(int offset, String str, AttributeSet a) throws BadLocationException {
		// apply insert
		super.insertString(offset, str, a);
	}
	
	public void applyRemove(int offset, int len) throws BadLocationException {
		// apply remove
