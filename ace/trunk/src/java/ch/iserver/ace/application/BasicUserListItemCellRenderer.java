...
public class BasicUserListItemCellRenderer extends JPanel implements ListCellRenderer {

	private BasicUserListItem value;
	private LocaleMessageSource source;
	protected ImageIcon iconUser;

	public BasicUserListItemCellRenderer(LocaleMessageSource source) {
	...
	public Component getListCellRendererComponent(JList list,
		...
		setOpaque(true);
		this.value = (BasicUserListItem)value;
