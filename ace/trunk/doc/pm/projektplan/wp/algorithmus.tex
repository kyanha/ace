\begin{table}[H]
 \begin{tabular}{|l|l|l|l|}
    \multicolumn{3}{|>{\columncolor[gray]{0.82}}p{5.85in}|}{\bfseries{\textsf{Work Package: Algorithmus implementieren}}} \\
  \hline
  ...
  \hline
    ...
    \multicolumn{1}{|p{3.5in}|}{Implementation Algorithmus} &
    \multicolumn{1}{|p{1in}|}{} \\
  \hline \hline
    \multicolumn{1}{|p{1in}|}{\bfseries{\textsf{Total}}} &
    \multicolumn{1}{|p{3.5in}|}{} &
    \multicolumn{1}{|p{1in}|}{20} \\
  \hline
 \end{tabular}
