\begin{table}[H]
 \begin{tabular}{|l|l|l|l|}
    \multicolumn{3}{|>{\columncolor[gray]{0.82}}p{5.85in}|}{\bfseries{\textsf{Work Package: Konzept Algorithmus}}} \\
  \hline
  ...
  \hline
    ...
    \multicolumn{2}{|p{4.5in}|}{Know-How von Research Algorithmen} \\
  \hline \hline
  ...
  \hline
    ...
    \multicolumn{1}{|p{3.5in}|}{Konzept Algorithmus} &
    \multicolumn{1}{|p{1in}|}{} \\
  \hline \hline
  ...
  \hline
 \end{tabular}
 \caption{Workpackage Konzept Algorithmus}
 \label{Workpackage Konzept Algorithmus}
\end{table}
