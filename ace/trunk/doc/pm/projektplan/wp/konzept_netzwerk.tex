\begin{table}[H]
 \begin{tabular}{|l|l|l|l|}
  \hline
   \multicolumn{3}{|>{\columncolor[gray]{0.82}}p{5.85in}|}{\bfseries{\textsf{Work Package: Bericht Netzwerk}}} \\
  \hline
  ...
  \hline
 \end{tabular}
 \caption{Workpackage Bericht Netzwerk}
 \label{Workpackage Bericht Netwerk}
\end{table}
