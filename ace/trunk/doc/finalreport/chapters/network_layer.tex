...
\begin{figure}[H]
 \centering
 \includegraphics[width=6.79in,height=6.18in]{../images/finalreport/network_package_view.eps}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=6.81in,height=4.51in]{../images/finalreport/network_discovery_uml.eps}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=6.32in,height=4.85in]{../images/finalreport/network_bonjour_uml.eps}
...
\paragraph{User Registration}
 ...
 various listener interfaces specified by the DNSSD API, namely  \texttt{RegisterListener},  \texttt{ResolveListener} and  \texttt{QueryListener}. This allows to have the user registration process separate from the peer discovery process, which uses the same listener interfaces.

\begin{figure}[H]
 \centering
 \includegraphics[width=6.62in,height=2.86in]{../images/finalreport/network_bonjour_uml.eps}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=6.54in,height=9.24in]{../images/finalreport/network_peerDiscovery_uml.eps}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=6.26in,height=4.76in]{../images/finalreport/network_dnssdCall_impl_uml.eps}
...
The following sequence diagram shows how the client uses the discovery and what happens behind an \texttt{execute()} call.

\begin{figure}[H]
 \centering
 \includegraphics[width=7.71in,height=7.53in]{/Users/lukaszbinden/eclipse-workspace/ACE-Trunk/doc/images/finalreport/network_discovery_sequence.eps}
