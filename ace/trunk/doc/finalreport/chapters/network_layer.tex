...
\begin{figure}[H]
 \centering
 \frame{
 \includegraphics[width=3.79in,height=3.40in]{../images/finalreport/network_remoteDocumentProxy_state.eps}
 }
...
\begin{figure}[H]
 \centering
  \frame{
 \includegraphics[width=5.88in,height=5.62in]{../images/finalreport/network_connection_uml.eps}
 }
...
The connection management is depicted in figure \ref{fig:network.discovery.connection.architecture}.
...
If a new protocol message must be implemented, to accomplish the processing for that message only a new message filter must be added to the filter chain. And this could even be done at runtime.
...
\begin{figure}[H]
 \centering
  \frame{
 \includegraphics[width=5.90in,height=2.93in]{../images/finalreport/network_requestFilter_uml.eps}
 }
...
\begin{figure}[H]
 \centering
  \frame{
 \includegraphics[width=5.72in,height=6.67in]{../images/finalreport/network_networkService_uml.eps}
 }
...
\begin{figure}[H]
 \centering
  \frame{
 \includegraphics[width=4.85in,height=4.51in]{../images/finalreport/network_publishedDocument_uml.eps}
 }
...
\begin{figure}[H]
 \centering
  \frame{
 \includegraphics[width=5.69in,height=3.65in]{../images/finalreport/network_architecture1_uml.eps}
 }
...
\begin{figure}[H]
 \centering
  \frame{
 \includegraphics[width=5.93in,height=5.69in]{../images/finalreport/network_userImpl_uml.eps}
 }
...
\begin{figure}[H]
 \centering
  \frame{
 \includegraphics[width=4.61in,height=3.25in]{../images/finalreport/network_mainConnectionSetup.eps}
 }
...
\begin{figure}[H]
 \centering
  \frame{
 \includegraphics[width=5.97in,height=5.04in]{../images/finalreport/network_participantConnectionImpl_uml.eps}
 }
...
\begin{figure}[H]
 \centering
  \frame{
 \includegraphics[width=5.00in,height=3.11in]{../images/finalreport/network_requestHandler_uml.eps}
 }
