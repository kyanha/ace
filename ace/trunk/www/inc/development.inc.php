...
<h3>Trac</h3>
<p>In the first stage of the project we used <a href="http://trac.edgewall.com/">trac</a>, a combined wiki, issue tracker, and repository
browser. Trac is still running, but we do not use it anymore as wiki and
...
<h4>User List</h4>
<a href="mailto:ace-users-subscribe@ace.iserver.ch">Subscribe</a>
<a href="mailto:ace-users-unsubscribe@ace.iserver.ch">Unsubscribe</a>
<p>This list is for users of the ACE application, to share knowledge, and to discuss issues.</p>

<h4>Developer List</h4>
<a href="mailto:ace-dev-subscribe@ace.iserver.ch">Subscribe</a>
<a href="mailto:ace-dev-unsubscribe@ace.iserver.ch">Unsubscribe</a>
<p>This list is for participating developers of ACE, where we can discuss issues, code changes/additions, etc.</p>
