 ...
 *
 */
public class GetPublishedDocumentsInFilter extends AbstractRequestFilter {

	private static Logger LOG = Logger.getLogger(GetPublishedDocumentsInFilter.class);
	
	private Serializer serializer;
	
	public GetPublishedDocumentsInFilter(RequestFilter successor) {
		super(successor);
