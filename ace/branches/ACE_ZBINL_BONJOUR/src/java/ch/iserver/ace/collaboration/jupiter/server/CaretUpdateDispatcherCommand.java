 ...
 *
 */
class CaretUpdateDispatcherCommand extends
				AbstractDispatcherCommand {
	
	private final CaretUpdateMessage message;
	
	public CaretUpdateDispatcherCommand(ParticipantConnection connection, int participantId, CaretUpdateMessage message) {
