 ...
 *
 */
public class GetPublishedDocumentsFilter extends AbstractRequestFilter {

	private static Logger LOG = Logger.getLogger(GetPublishedDocumentsFilter.class);
	
	private Serializer serializer;
	
	public GetPublishedDocumentsFilter(RequestFilter successor) {
		super(successor);
