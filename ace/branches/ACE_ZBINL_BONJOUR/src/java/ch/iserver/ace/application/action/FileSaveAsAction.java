...
public class FileSaveAsAction extends ItemSelectionChangeAction {
	...
	public FileSaveAsAction(LocaleMessageSource messageSource, ViewController controller) {
		super(messageSource.getMessage("mFileSaveAs"), messageSource.getIcon("iMenuFileSaveAs"), controller);
		setEnabled(true);
	}
