...
public class RequestDispatcherCommandTest extends TestCase {

	/**
	 * Test method for 'ch.iserver.ace.collaboration.jupiter.server.RequestDispatcherCommand.execute()'
	 */
	public void testExecute() {
		...
		RequestDispatcherCommand cmd = new RequestDispatcherCommand(
						connection, 1, request);
		
		// define mock behavior
		connection.sendRequest(1, request);
